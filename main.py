...
print(Fore.LIGHTMAGENTA_EX ,f"""
      _                                       
     | |                                      
   __| |_ __ __ _  __ _  ___  _ __ __  ___ __ 
  / _` | '__/ _` |/ _` |/ _ \| '_ \\ \/ / '__|
 | (_| | | | (_| | (_| | (_) | | | |>  <| |   
  \__,_|_|  \__,_|\__, |\___/|_| |_/_/\_\_|   
                   __/ |                      
                  |___/           
""")
...
useragent = "Mozilla/5.0 (Windows; U; Windows NT 5.1; zh-TW; rv:1.9.1.2) Gecko/20090729 Firefox/3.5.2"
    ...
    try:
        r = session.post('https://discord.com/api/v9/auth/register',json={  
            ...
            "promotional_email_opt_in": True
                ...
                'Host': 'discord.com',
                'User-Agent': 'Mozilla/5.0 (Windows; U; Windows NT 5.1; zh-TW; rv:1.9.1.2) Gecko/20090729 Firefox/3.5.2',
                'Accept': '*/*',
                'Accept-Language': 'en-US,en;q=0.5',
                'Accept-Encoding': 'gzip, deflate, br',
                'Content-Type': 'application/json',
                'X-Super-Properties': '',
